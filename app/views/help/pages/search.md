...
tag:priority[from:core-team]      # Topics tagged "priority" by core-team members
...
from:core-team[messages:>=5]           # Team posted 5+ combined messages
...
tag:[from:me]                          # Any tag from me (same as tag:@me)
tag:important[added_after:1w]          # "important" tags added this week
tag:blocked[from:core-team]            # "blocked" by core team
...
```
(has:patch OR has:attachment) started_after:1m -has:contributor
```
